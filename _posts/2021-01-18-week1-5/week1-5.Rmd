...
First, let's read in the gapminder dataset that we used in the introduction to
vega-lite.
...
Aside from some small differences in the encoding syntax and default styling,
the result is almost identical in vega-lite.
...
rather than precomputing these summary statistics.
...
For the 30 and 70% quantiles, we can't use a built-in vega-lite function, like
