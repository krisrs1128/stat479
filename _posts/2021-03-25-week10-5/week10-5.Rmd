...
_Reading [1](https://juliasilge.com/blog/cocktail-recipes-umap/) and [2](https://pair-code.github.io/understanding-umap), [Recording](), [Rmarkdown](https://github.com/krisrs1128/stat479/blob/master/_posts/2021-03-25-week10-5/week10-5.Rmd)_
...
```{r, fig.width = 7, fig.height = 7, fig.cap = "Principal component scores from the fashion dataset."}
scores <- juice(pca_prep) %>%
  rename(x = PC1, y = PC2)
...
```{r, fig.width = 7, fig.height = 7, preview = TRUE, fig.cap = "A subset of principal component scores expressed as the corresponding images."}
...
```{r, fig.cap = "The locations of all the images according to UMAP. Each color is a different class."}
...
```{r, fig.cap = "A sample of the images at the locations determined by UMAP."}
