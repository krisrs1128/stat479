...
_[Reading](https://jjallaire.github.io/deep-learning-with-r-notebooks/notebooks/5.4-visualizing-what-convnets-learn.nb.html), [Recording](), [Rmarkdown](https://github.com/krisrs1128/stat479/blob/master/_posts/2021-04-12-week13-2/week13-2.Rmd)_
...
```{r, fig.show = "hold", out.width = "47%", fig.height = 7, fig.cap = "An image and its activations for the first neuron in layer 1."}
