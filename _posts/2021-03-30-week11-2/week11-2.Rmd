...
_[Reading](https://www.tidytextmining.com/topicmodeling.html), [Recording](), [Rmarkdown](https://github.com/krisrs1128/stat479/blob/master/_posts/2021-03-30-week11-2/week11-2.Rmd)_
...
```{r}
write_csv(topics, "~/Desktop/topics.csv")
write_csv(memberships,"~/Desktop/memberships.csv")
```

```{r}
table(memberships$document)
```
