...
observation $i$ is $s_{i}:= \frac{b_{i} - a_{i}}{\max{a_{i}, b\_{i}}$. This
number is close to 1 if the orange segments are much longer than the green
segments, close to 0 if the segments are about the same size, and close to -1 if
the the orange segments are much shorter than the green segments^[This last case
likely indicates a misclustering.].
