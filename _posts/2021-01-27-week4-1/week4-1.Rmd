...
3. The tidy data might seem like an idea so natural that it’s not worth teaching (let alone formalizing). However, exceptions are encountered frequently, and it’s important that you be able to spot them. Further, there are now many utiliities for "tidying" data, and they are worth becoming familiar with.
...
once now have to be copied onto each row).