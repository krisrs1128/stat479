...
description: |
  Entity resolution and other ways visualization can support data cleaning.
author:
  - name: Kris Sankaran
...
_[Reading](https://idl.cs.washington.edu/files/2012-Profiler-AVI.pdf), [Recording](), [Rmarkdown](https://raw.githubusercontent.com/krisrs1128/stat479/master/_posts/2021-01-30-week5-5/week5-5.Rmd)_
...
the end, it doesn't seem like there are any true duplicates. The closest we get
is that Tarzan and Taxman both came out in 1999...

```{r}
movies <- movies %>%
  mutate(year = str_extract(Release_Date, "19[0-9]+"))
