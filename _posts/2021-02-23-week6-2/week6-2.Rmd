...
4. Finally, it's worth keeping in mind that real-world structure can be much
more complicated than any of these patterns. For example, the plot below shows
the number of passengers on flights from Melbourne to Sydney between 1987 and
1992. You can see a period when no flights were made and a trial in 1992 where
economy seats were switched to business seats.
