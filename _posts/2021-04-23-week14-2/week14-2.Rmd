...
_[Reading](https://www.datasketch.es/project/655-frustrations-doing-data-visualization), [Recording](), [Rmarkdown](https://github.com/krisrs1128/stat479/blob/master/_posts/2021-04-23-week14-2/week14-2.Rmd)_
...
```{r, fig.cap = "Example exploratory displays of the 'percentage of time' questions on the data science survey."}
...
```{r, fig.cap = "A screenshot of notes from the author's interaction with the resulting visualization."}
