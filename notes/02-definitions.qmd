...
<img src="figures/black_box_flashlight.png" width=1200 class="center"/>
...
argued that it can be misleading [@Rudin2019].
:::
...
relationships. The steps below are based off [@Murdoch2019].
...
- How closely does the distilled model match the original model's predictions?
...
The talk [@kim_iclr] describes how interpretability bridges human and machine "concepts."
