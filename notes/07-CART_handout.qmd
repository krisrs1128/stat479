...
![An ad-hoc decision tree used by the San Diego Medical Center for assessing heart attack patients, part of the [inspiration](https://rafalab.dfci.harvard.edu/pages/649/section-11.pdf) behind CART.](figures/heart_attack_cart.gif){width="300px"}
...
y_i}\right)\}_{i = 1}^{N}$? If we have only one feature and are only allowed one
split, then it's natural to pick $s$ to minimize
