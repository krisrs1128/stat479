...
class="purple">$f$</span> that ignores any of the real data coordinates in $S$
and replaces them by a baseline value <span class="darkblue">$x'$</span>.
...
another and then compute the same quantify for many samples. The columns are
