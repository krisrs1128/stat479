---
title: 4. Applying Linear Models
...
- Often, people assume that to get higher accuracy, we need "black-box" models (like deep learning or Random Forests) and sacrifice interpretability.
 ...
 - But in many scientific problems (like today's case study, see also [@openproblemsBenchmarksOpen]), sparse linear models are surprisingly competitive, while remaining more interpretable to more audiences. It depends on the true relationship between predicators and response in the data.
