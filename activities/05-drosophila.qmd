...
many samples, the `wt_ZLD`, `input_c14c`, and `sna` features stand out. For most
...
This is consistent with the data, where large `sna1` suppresses enhancer
activity.  The [`sna1`](https://en.wikipedia.org/wiki/SNAI1) gene is a
transcriptional repressor, so this makes sense biologically.
