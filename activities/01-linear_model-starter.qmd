...
You can download the primary source data from [this
...
f <- tempfile()
download.file("https://zenodo.org/api/records/18371236/draft/files/01-cll.rds/content", f)
cll_data <- readRDS(f)
```
...
(Aside: Show how to render this notebook for sharing! Show terminal command and
walk through YAML header).
