...
1. Predict ${\color{#2563EB}\hat{f}\left(x_{m}^{*}\right)}$ at test points ${\color{#D946A6}x_{1}^{\ast}, \dots, x_{M}^{\ast}}$.
2. Quantify associated prediction ${\color{#22A456}\text{uncertainties}}$.

![](figures/gp_motivation_overview.png){width="400px"}

**Requirements.**

   1. Incorporate domain knowledge about the function (e.g., "the function is periodic").
   2. Use interpretable hyperparameters (e.g., "p is the period").
...
1. The greta.gp package makes this much simpler.
